...
var sackmesserApp = angular.module('sackmesserApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'sackmesserAppUtils', 'pascalprecht.translate', 'truncate']);
